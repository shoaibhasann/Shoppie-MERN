          ...
          <div className="grid grid-cols-1 gap-10 lg:grid-cols-4 px-6 py-8 lg:p-8">
            <div className="flex flex-col items-start justify-center gap-5">
              ...
              <p className="text-gray-300">
                Embark on a seamless online shopping journey with Shoppie!
                Discover, shop, and experience convenience like never before.
                Welcome to Shoppie!
              </p>
            ...
            >
              ...
              <div className="mt-4 flex">
                ...
                <button
                  type="submit"
                  className="bg-red-500 hover:bg-red-600 text-white px-4 rounded-r-md focus:outline-none focus:ring-none focus:border-red-300"
                >
                  Subscribe
                </button>
              </div>
